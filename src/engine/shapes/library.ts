 ...
 * 56 defs, for two reasons: it keeps the choice reviewable in one place
 * instead of scattered across two 500+ line authored files, and it fixes the
 * palette ORDER independently of the category grouping — so the Simple view
 * reads shapes-then-subjects-then-bands rather than in library order.
 *
